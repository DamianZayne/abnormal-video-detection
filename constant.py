...
def parser_args():
    ...
    parser.add_argument('--snapshot_dir', type=str, default='./outputs/checkpoints/temporal/avenue/'
                                                            'prednet_cyclegan_convlstm_folds_10_kth_1_/'
                                                            'MARGIN_1.0_LAMBDA_1.0/model.ckpt-81000',
